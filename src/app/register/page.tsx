  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#FAFAF7] px-6 py-12">
      <div className="w-full max-w-md rounded-[2rem] bg-white p-8 shadow-2xl">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-3xl bg-[#0B2D4D] text-[#F5C451]">
        ...
        <p className="mt-3 text-center text-sm leading-6 text-slate-500">
          Form register akan dibuat pada part berikutnya dan disambungkan ke
          endpoint <span className="font-bold">/auth/register</span>.
        </p>
